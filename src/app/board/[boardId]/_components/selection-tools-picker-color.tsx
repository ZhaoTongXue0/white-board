...
interface SelectionToolsPickerColorProps {
...
const ColorButton = (
  {onClick, color}: ColorButtonProps
) => {
  return (
    <button
...
export const SelectionToolsPickerColor = (
  {onChange}: SelectionToolsPickerColorProps
) => {
  return (
    <div
    ...
    >
      ...
      <ColorButton onClick={onChange} color={{r: 60, g: 202, b: 99,}}/>
